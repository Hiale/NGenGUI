...
namespace Hiale.NgenGui.FolderBrowserDialog.Interop
{
    [ComImport,
    ...
    //    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    //    void FindFolderFromPath([In, MarshalAs(UnmanagedType.LPWStr)] string pszPath, [In] NativeMethods.FFFP_MODE mode,
    //                            [MarshalAs(UnmanagedType.Interface)] out IKnownFolder ppkf);
